...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-a-number-needs-a-tree.html", "a2-leading-vs-lagging.html",
           "a3-decompose-and-read-a-drop.html", "a4-six-domains-side-by-side.html",
           "a5-weekly-business-review.html", "a6-monthly-leadership-summit.html"]
        : ["b1-first-driver-tree.html", "b2-three-patterns.html", "b3-leading-indicators-playbook.html",
           "b4-ecommerce-deep-dive.html", "b5-marketing-deep-dive.html",
           "b6-branding-deep-dive.html", "b7-internet-traffic-deep-dive.html",
           "b8-b2b-saas-deep-dive.html", "b9-b2g-deep-dive.html", "b10-capstone.html"];
